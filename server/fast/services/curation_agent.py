...
# TODO: Alternative chain of commands. Instead of calling each prompt in a chain you can use multiple functions. This will give even greater customizability
